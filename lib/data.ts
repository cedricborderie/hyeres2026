...
export const proposals: Proposal[] = [
...

  {
    ...
    summary: "Protéger les Rougières et instaurer un moratoire. Appliquer la Loi Climat.",
    details: "Créer des zones agricoles protégées (ZAP), appliquer l'objectif de réduction de consommation d'espaces (Loi Climat) et redonner une vocation agricole à la zone des Rougières et instaurer un moratoire."
  },
...

  {
    id: "h9",
    categoryId: "habitat",
    title: "H9. Accélérer la révision du PPRI (Compétence de l'Etat)",
    summary: "La municipalité vigie pour identifier les zones d'expansion des crues",
    details: "Bien que le PPRI relève de la compétence de l'État, la municipalité peut être force de proposition, en s'appuyant sur sa connaissance fine du terrain pour identifier les nouvelles zones d'expansion des crues à préserver, garantissant ainsi une urbanisation résiliente."
  },
...

  {
    id: "h12",
    categoryId: "habitat",
    title: "H12. Réduire les îlots de chaleur urbains",
...

  {
    ...
    details: "Utiliser les 318 000€ d'amendes annuelles (loi SRU) pour préempter et rénover des immeubles anciens du centre-ville au lieu de payer des pénalités à l'État ou de se reposer sur des promoteurs privés."
  },
