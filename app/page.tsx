    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-primary-50">
      <div className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          {/* Section: Pour un Hyères Désirable */}
          <section>
          ...
          {/* Section: Nos 3 Champs d'Expertise */}
          <section>
          ...
          {/* Section: Votre Voix Compte */}
          <section className="bg-primary-50 rounded-lg p-8 md:p-12 text-center">
